...
/**
 * Internal manifest-only preparation boundary for deterministic-fake typed model work.
 *
 * <p>Exact replay resolves and validates the stored immutable manifest without consulting
 * current repository state. First use derives repository-owned authority and persists the
 * resulting manifest before any Scheduler queue dependency is involved.
 */
final class DeterministicFakeModelSubmissionManifestPreparer {
    ...
    PreparedDeterministicFakeModelSubmission prepare(
        ...
        return new PreparedDeterministicFakeModelSubmission(
